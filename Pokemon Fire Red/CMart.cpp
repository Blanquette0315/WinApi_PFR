...
CMart::CMart()
	...
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"Mart");

	AddCollider(L"Image\\map\\Building\\Mart.Collider");
}
...
void CMart::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CMart::CollisionOverlap(CCollider* _pOtherCollider)
{
	// ImegeRender
	if (dynamic_cast<CPlayer*>(_pOtherCollider->GetOwner()))
	{
...
void CMart::CollisionEndOverlap(CCollider* _pOtherCollider)
{

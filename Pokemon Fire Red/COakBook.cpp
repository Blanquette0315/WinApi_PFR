...
COakBook::COakBook()
	...
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"OakBook");

	AddCollider(L"Image\\map\\Environment\\Inside\\OakBook.Collider");
}
...
void COakBook::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void COakBook::CollisionOverlap(CCollider* _pOtherCollider)
{
	// ImegeRender
	if (dynamic_cast<CPlayer*>(_pOtherCollider->GetOwner()))
	{
...
void COakBook::CollisionEndOverlap(CCollider* _pOtherCollider)
{

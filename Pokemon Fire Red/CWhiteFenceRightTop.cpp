...
CWhiteFenceRightTop::CWhiteFenceRightTop()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"WhiteFenceRightTop");

	AddCollider(L"Image\\map\\Environment\\WhiteFenceRightTop.Collider");
}
...
void CWhiteFenceRightTop::tick()
{
	CEnvironment::tick();
}

void CWhiteFenceRightTop::render(HDC _dc)
{
...
void CWhiteFenceRightTop::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CWhiteFenceRightTop::CollisionOverlap(CCollider* _pOtherCollider)
{

}

void CWhiteFenceRightTop::CollisionEndOverlap(CCollider* _pOtherCollider)
{

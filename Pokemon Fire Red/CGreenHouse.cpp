...
CGreenHouse::CGreenHouse()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, IS_Event(false)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"GreenHouse");

	AddCollider(L"Image\\map\\Building\\GreenHouse.Collider");
}
...
void CGreenHouse::render(HDC _dc)
{
...
void CGreenHouse::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CGreenHouse::CollisionOverlap(CCollider* _pOtherCollider)
{
	
}

void CGreenHouse::CollisionEndOverlap(CCollider* _pOtherCollider)
{

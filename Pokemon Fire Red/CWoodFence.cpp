...
CWoodFence::CWoodFence()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"WoodFence");

	AddCollider(L"Image\\map\\Environment\\WoodFence.Collider");
}
...
void CWoodFence::tick()
{
	CEnvironment::tick();
}

void CWoodFence::render(HDC _dc)
{
...
void CWoodFence::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CWoodFence::CollisionOverlap(CCollider* _pOtherCollider)
{

}

void CWoodFence::CollisionEndOverlap(CCollider* _pOtherCollider)
{

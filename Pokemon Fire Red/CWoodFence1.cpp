...
CWoodFence1::CWoodFence1()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"WoodFence1");

	AddCollider(L"Image\\map\\Environment\\WoodFence1.Collider");
}
...
void CWoodFence1::tick()
{
	CEnvironment::tick();
}

void CWoodFence1::render(HDC _dc)
{
...
void CWoodFence1::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CWoodFence1::CollisionOverlap(CCollider* _pOtherCollider)
{

}

void CWoodFence1::CollisionEndOverlap(CCollider* _pOtherCollider)
{

...
CRockTile::CRockTile()
	...
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"RockTile");

	AddCollider(L"Image\\map\\Environment\\RockTile.Collider");
}
...
void CRockTile::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CRockTile::CollisionOverlap(CCollider* _pOtherCollider)
{
	// ImegeRender
	if (dynamic_cast<CPlayer*>(_pOtherCollider->GetOwner()))
	{
...
void CRockTile::CollisionEndOverlap(CCollider* _pOtherCollider)
{

...
CMuseumStand1::CMuseumStand1()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"Museum2fStand");

	AddCollider(L"Image\\map\\Environment\\Inside\\Museum2fStand.Collider");
}
...
void CMuseumStand1::tick()
{
	CEnvironment::tick();
}

void CMuseumStand1::render(HDC _dc)
{
...
void CMuseumStand1::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CMuseumStand1::CollisionOverlap(CCollider* _pOtherCollider)
{
	// ImegeRender
	if (dynamic_cast<CPlayer*>(_pOtherCollider->GetOwner()))
	{
...
void CMuseumStand1::CollisionEndOverlap(CCollider* _pOtherCollider)
{

...
CHouseBlackRoof::CHouseBlackRoof()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"HouseBlackRoof");

	AddCollider(L"Image\\map\\Building\\HouseBlackRoof.Collider");
}
...
void CHouseBlackRoof::tick()
{
	CEnvironment::tick();
}

void CHouseBlackRoof::render(HDC _dc)
{
...
void CHouseBlackRoof::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CHouseBlackRoof::CollisionOverlap(CCollider* _pOtherCollider)
{
	// ImegeRender
	if (dynamic_cast<CPlayer*>(_pOtherCollider->GetOwner()))
	{
...
void CHouseBlackRoof::CollisionEndOverlap(CCollider* _pOtherCollider)
{

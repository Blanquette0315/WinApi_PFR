...
CMuseum::CMuseum()
	...
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"Museum");

	AddCollider(L"Image\\map\\Building\\Museum.Collider");
}
...
void CMuseum::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CMuseum::CollisionOverlap(CCollider* _pOtherCollider)
{
	// ImegeRender
	if (dynamic_cast<CPlayer*>(_pOtherCollider->GetOwner()))
	{
...
void CMuseum::CollisionEndOverlap(CCollider* _pOtherCollider)
{

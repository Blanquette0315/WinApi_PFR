...
CBed::CBed()
	...
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"Bed");

	AddCollider(L"Image\\map\\Environment\\Inside\\Bed.Collider");
}
...
void CBed::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CBed::CollisionOverlap(CCollider* _pOtherCollider)
{
	// ImegeRender
	if (dynamic_cast<CPlayer*>(_pOtherCollider->GetOwner()))
	{
...
void CBed::CollisionEndOverlap(CCollider* _pOtherCollider)
{

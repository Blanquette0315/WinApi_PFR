...
CWoodFenceLeftTop::CWoodFenceLeftTop()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"WoodFenceLeftTop");

	AddCollider(L"Image\\map\\Environment\\WoodFenceLeftTop.Collider");
}
...
void CWoodFenceLeftTop::tick()
{
	CEnvironment::tick();
}

void CWoodFenceLeftTop::render(HDC _dc)
{
...
void CWoodFenceLeftTop::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CWoodFenceLeftTop::CollisionOverlap(CCollider* _pOtherCollider)
{

}

void CWoodFenceLeftTop::CollisionEndOverlap(CCollider* _pOtherCollider)
{

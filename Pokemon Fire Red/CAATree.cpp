...
CAATree::CAATree()
	...
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"AATree");

	AddCollider(L"Image\\map\\Environment\\AATree.Collider");
}
...
void CAATree::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CAATree::CollisionOverlap(CCollider* _pOtherCollider)
{
	// ImegeRender
	if (dynamic_cast<CPlayer*>(_pOtherCollider->GetOwner()))
	{
...
void CAATree::CollisionEndOverlap(CCollider* _pOtherCollider)
{

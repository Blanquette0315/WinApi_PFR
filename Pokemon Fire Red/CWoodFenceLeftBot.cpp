...
CWoodFenceLeftBot::CWoodFenceLeftBot()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"WoodFenceLeftBot");

	AddCollider(L"Image\\map\\Environment\\WoodFenceLeftBot.Collider");
}
...
void CWoodFenceLeftBot::tick()
{
	CEnvironment::tick();
}

void CWoodFenceLeftBot::render(HDC _dc)
{
...
void CWoodFenceLeftBot::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CWoodFenceLeftBot::CollisionOverlap(CCollider* _pOtherCollider)
{

}

void CWoodFenceLeftBot::CollisionEndOverlap(CCollider* _pOtherCollider)
{

...
CMartStand1::CMartStand1()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"MartStand1");

	AddCollider(L"Image\\map\\Environment\\Inside\\MartStand1.Collider");
}
...
void CMartStand1::tick()
{
	CEnvironment::tick();
}

void CMartStand1::render(HDC _dc)
{
...
void CMartStand1::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CMartStand1::CollisionOverlap(CCollider* _pOtherCollider)
{
	// ImegeRender
	if (dynamic_cast<CPlayer*>(_pOtherCollider->GetOwner()))
	{
...
void CMartStand1::CollisionEndOverlap(CCollider* _pOtherCollider)
{

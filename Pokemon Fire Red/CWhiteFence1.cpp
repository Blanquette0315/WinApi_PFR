...
CWhiteFence1::CWhiteFence1()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"WhiteFence1");

	AddCollider(L"Image\\map\\Environment\\WhiteFence1.Collider");
}
...
void CWhiteFence1::tick()
{
	CEnvironment::tick();
}

void CWhiteFence1::render(HDC _dc)
{
...
void CWhiteFence1::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CWhiteFence1::CollisionOverlap(CCollider* _pOtherCollider)
{

}

void CWhiteFence1::CollisionEndOverlap(CCollider* _pOtherCollider)
{

...
CGym::CGym()
	...
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"Gym");

	AddCollider(L"Image\\map\\Building\\Gym.Collider");
}
...
void CGym::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CGym::CollisionOverlap(CCollider* _pOtherCollider)
{
	// ImegeRender
	if (dynamic_cast<CPlayer*>(_pOtherCollider->GetOwner()))
	{
...
void CGym::CollisionEndOverlap(CCollider* _pOtherCollider)
{

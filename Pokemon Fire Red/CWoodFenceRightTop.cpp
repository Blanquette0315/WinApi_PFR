...
CWoodFenceRightTop::CWoodFenceRightTop()
	: m_pImage(nullptr)
	, IS_Collision(false)
	, m_iRe_render(0)
{
	m_pImage = CResourceMgr::CreateMgr()->FindImg(L"WoodFenceRightTop");

	AddCollider(L"Image\\map\\Environment\\WoodFenceRightTop.Collider");
}
...
void CWoodFenceRightTop::tick()
{
	CEnvironment::tick();
}

void CWoodFenceRightTop::render(HDC _dc)
{
...
void CWoodFenceRightTop::CollisionBeginOverlap(CCollider* _pOtherCollider)
{
...
void CWoodFenceRightTop::CollisionOverlap(CCollider* _pOtherCollider)
{

}

void CWoodFenceRightTop::CollisionEndOverlap(CCollider* _pOtherCollider)
{
